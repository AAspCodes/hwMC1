...
public class Grid {
	...
	public static boolean rowFilled = false; // Added a boolean for filled row
	...
	public void checkRows() {
		...
		// Starts at a row and goes through a column
		// if the column has an empty square
		...
		for (int r = 0; r < Grid.HEIGHT; r++){  	
			for (int c = 0; c < Grid.WIDTH; c++){	
				...
				// If the loop gets to the end of the column
				// Start a new loop setting every square to EMPTY
				if (c == Grid.WIDTH - 1){
					for (int col = 0; col < WIDTH; col++){
						set(r, col, EMPTY);
						rowFilled = true;
					...
					// After the above for loop execute the moveDown method
